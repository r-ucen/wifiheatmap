...
export class Tab1Page implements OnInit, OnDestroy {
  ...
  turnLeft() {
    switch(this.currentDirection) {
      case Direction.Up:
        this.currentDirection = Direction.Left; break;
      case Direction.Down:
        this.currentDirection = Direction.Right; break;
      case Direction.Left:
        this.currentDirection = Direction.Down; break;
      case Direction.Right:
        this.currentDirection = Direction.Up; break
    }
  }
  ...
  startScanning(measure: boolean) {
    ...
    const interval = measure ? this.settings.scanActiveIntervalMs : this.settings.scanPassiveIntervalMs

    this.scanSub = timer(0, interval).pipe(
  ...
  move() {
    switch (this.currentDirection) {
      case Direction.Up:
        this.currentY -= this.settings.stepSize; break;
      case Direction.Down:
        this.currentY += this.settings.stepSize; break;
      case Direction.Left:
        this.currentX -= this.settings.stepSize; break;
      case Direction.Right:
        this.currentX += this.settings.stepSize; break;
    }
  }
  ...
  measure() {
    this.heatmapPoints.push({ x: this.currentX, y: this.currentY, rssi: this.currentRssi })
  }
